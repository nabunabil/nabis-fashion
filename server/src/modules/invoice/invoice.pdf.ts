...
export async function createInvoicePdfBuffer(orderId: number): Promise<Buffer> {
  ...
  try {
    ...
    console.warn(
      `[InvoicePDF] Database lookup warning for order #${orderId}:`,
      err,
    );
  }
  ...
  try {
    storeSettings = await prisma.storeSetting.findUnique({ where: { id: 1 } });
  } catch (_) {}
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .text(
          `Support: ${storeSettings?.supportEmail || "support@nabisfashion.com"} | Hotline: +880 1711-223344`,
          35,
          86,
          { width: 280 },
        );
      ...
      const custEmail =
        order.user?.email || order.email || "client@nabisfashion.com";
      ...
      doc
        ...
        .text(
          deliveryFeeNum === 0 ? "FREE" : `${currSymbol}${deliveryFeeNum.toFixed(2)}`,
          valueX,
          currentSumY,
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          "• 100% Certified Authentic Bengali Craftsmanship.",
          45,
          notesY + 25,
        )
        .text(
          "• 7-Day Hassle-Free Returns & Concierge Exchanges.",
          45,
          notesY + 38,
        )
        .text(
          "• Handcrafted using pure silk and organic cotton fibers.",
          45,
          notesY + 51,
        )
        .fillColor(COLOR_TEXT_MUTED)
        .fontSize(7)
        .text(
          `Security Verification Ref: NF-AUTH-${order.id}-${Math.floor(100000 + Math.random() * 900000)}`,
          45,
          notesY + 70,
        )
        .text(
          `Digitally signed and sealed on ${orderDateStr}`,
          45,
          notesY + 82,
        );
      ...
      doc
        ...
        .font("Helvetica")
        .text(
          "Your order has been handcrafted with elegance. We appreciate your patronage of luxury Bengali fashion.",
          45,
          footerY + 34,
        ...
        .fontSize(7)
        .text(
          "For assistance, sizing recommendations, or bespoke orders: support@nabisfashion.com | www.nabisfashion.com",
          45,
          footerY + 48,
          { width: 505, align: "center" },
        )
        ...
        .fillColor("#9CA3AF")
        .text(
          "This document serves as an official tax invoice and purchase receipt under Bangladesh Trade Regulations.",
          45,
          footerY + 60,
          { width: 505, align: "center" },
        );
