...
export type OrderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "totalPrice" | "orderStatus" | "paymentMethod" | "paymentStatus" | "stripePaymentIntent" | "customerName" | "phone" | "address" | "city" | "postalCode" | "createdAt", ExtArgs["result"]["order"]>;
