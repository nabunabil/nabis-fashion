...
exports.deleteFileFromCloudinary = exports.uploadBufferToCloudinary = void 0;
const cloudinary_1 = require("cloudinary");
const streamifier_1 = __importDefault(require("streamifier"));
const env_1 = require("../lib/env");
const cloudName = env_1.env.cloudinaryCloudName;
const apiKey = env_1.env.cloudinaryApiKey;
const apiSecret = env_1.env.cloudinaryApiSecret;
